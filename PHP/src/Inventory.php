...
<head>
  ...
  <title>Dionysus Inventory</title>
  <!-- Icons-->
    ...
    <div class="sidebar">
      <nav class="sidebar-nav">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Beer.php">
              <i class="nav-icon icon-drop"></i> Beer</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="Ingredients.php">
              <i class="nav-icon icon-pencil"></i> Ingredients</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="Kegs.php">
              <i class="nav-icon icon-drop"></i> Kegs</a>
          </li>
        </ul>
      </nav>
    </div>
