            ...
            <div class="animated fadeIn">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-6 col-lg-3">
                     <div class="card">
                        <div class="card-body">
                           <div><img style="width:100%;" src="IMG/ReportsIcon.jpg"></div>
                           <div class="text-value">Generate ReportReports</div>
                           <form action="report.php" method="post">
                              <button class="primary-btn" ><div>Business Summary and Breakdowns</div></button>
                           </form>
