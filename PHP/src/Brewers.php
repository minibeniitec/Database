...
$result = pg_query($db, "Select * from getmonthlyyields;");
$array = pg_fetch_all($result);
$dataPoints = array();
if ($array) {
  foreach ($array as $arr) {
    $tmp = array('label' => $arr['firstname'] + $arr['lastname'], 'y' => $arr['sum']);
    $dataPoints[] = $tmp;
  }
} else {
        ...
        <div class="animated fadeIn">
          ...
          <div class="card-group mb-4">
            <div class="card">
              ...
              <div class="text-value text-center">This Month's</div>
              <h1 class="text-center">Top Brewers</h1>
            </div>
            <div class="card">
              <div class="card-body">
