            ...
            <div class="animated fadeIn">
               ...
               <div class="row">
                  <div class="col-sm-6 col-lg-3">
                     <div class="card">
                        <div class="card-body">
                           <div><a href="SalesTeam.php"><img style="width:100%;" src="IMG/SalesTeamIcon.jpg"></a></div>
                           <div class="text-value">Sales Team</div>
                           <div>We Make You Money</div>
                  ...
                  <div class="col-sm-6 col-lg-3">
                     <div class="card">
                        <div class="card-body">
                           <div><a href="Brewers.php"><img style="width:100%;" src="IMG/BrewersIcon.jpg"></a></div></br>
                           <div class="text-value">Brewers</div>
                           <div>The Makers of Beer</div>
                           <div class="progress progress-xs my-2">
                  ...
                  <div class="col-sm-6 col-lg-3">
                     <div class="card">
                        <div class="card-body"> </br>
                           <div><a href="Managers.php"><img style="width:100%;" src="IMG/ManagersIcon.jpg"></a></div></br>
                           <div class="text-value">Managers</div>
                           <div>We Make Things Happen</div>
                           <div class="progress progress-xs my-2">
                  ...
                  <div class="col-sm-6 col-lg-3">
                     <div class="card">
                        <div class="card-body">
                           <div><a href="AllEmployees.php"><img style="width:100%;" src="IMG/All.jpg"></a></div>
                           <div class="text-value">All</div>
